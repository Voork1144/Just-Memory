...
exports.quickSanitize = quickSanitize;
exports.hasProblematicChars = hasProblematicChars;
exports.sanitizeObjectForJson = sanitizeObjectForJson;
exports.escapeForDisplay = escapeForDisplay;
/**
 ...
 */
function sanitizeForJson(str, options = {}) {
...
function hasProblematicChars(str) {
    return (C0_CONTROL_CHARS.test(str) ||
